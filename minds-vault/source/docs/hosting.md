...
> [!hint]
> Some Quartz features (like [[RSS Feed]] and sitemap generation) require `baseUrl` to be configured properly in your [[Engine/minds-vault/source/docs/configuration]] to work properly. Make sure you set this before deploying!
