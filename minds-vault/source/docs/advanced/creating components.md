...
Then, you can use it like any other component in `quartz.layout.ts` via `Component.YourComponent()`. See the [[Engine/minds-vault/source/docs/configuration#Layout|layout]] section for more details.
